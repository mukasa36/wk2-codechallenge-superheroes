...
def create_sample_power():
    with app.app_context():
        ...
        hero_power1 = HeroPowers(hero=hero1, power=power1, strength='Strong')
        hero_power2 = HeroPowers(hero=hero1, power=power2, strength='Average')
        hero_power3 = HeroPowers(hero=hero2, power=power3, strength='Weak')
        hero_power4 = HeroPowers(hero=hero3, power=power4, strength='Weak')
        hero_power5 = HeroPowers(hero=hero4, power=power2, strength='Strong')
